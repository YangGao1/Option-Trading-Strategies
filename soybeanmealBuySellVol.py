...
class SoybeanmealBuySellVol(object):
    ...
    def Monitor(self):
        ...
        print "Soybean Meal BuySellVol:",self.Code, datetime.now()
...
if __name__ == '__main__':
    ...
    '''监控开始'''
    BSV = SoybeanmealBuySellVol(myCode, myPosition, myHVPeriod, myTotalTime, myType, myStdPara, myCoverPara)
    timeInterval = 1
